...
public class FindCommand extends SimpleCommand {
    ...
    protected FindCommand(JavaPlugin plugin, SimpleCommand parent, String label) {
        super(plugin, parent, label);
        setUsage("/crystal find");
        setDescription("寻找附近的魔晶矿");
        setPlayerOnly();
        setAdminCommand();
    }
    ...
    public void onCommand() {
        ...
        Message.sendWarn(player, "寻找魔晶矿中, 这可能需要一些时间...");
